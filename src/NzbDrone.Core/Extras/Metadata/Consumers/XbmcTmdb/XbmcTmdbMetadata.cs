    ...
    public class XbmcTmdbMetadata : MetadataBase<XbmcTmdbMetadataSettings>
    {
        ...
        public override MetadataFileResult SeriesMetadata(Series series)
        {
            ...
            var tmdbTvShow = TmdbClient
                .GetTvShowAsync(series.TvRageId, tvShowMethods)
                .Result;
            ...
            using (var xw = XmlWriter.Create(sb, xws))
            {
                ...
                tvShow.Add(new XElement("runtime", series.Runtime));

                var episodeGuideUrl = string.Format($"http://www.thetvdb.com/api/1D62F2F90030C444/series/{0}/all/{CountryCode}.zip", series.TvdbId);
        ...
        public override MetadataFileResult EpisodeMetadata(Series series, EpisodeFile episodeFile)
        {
            ...
            foreach (var episode in episodeFile.Episodes.Value)
            {
                ...
                var tvEpisode = TmdbClient
                    .GetTvEpisodeAsync(series.TvRageId, episode.SeasonNumber, episode.EpisodeNumber, tvEpisodeMethods)
                    .Result;
                ...
                using (var xw = XmlWriter.Create(sb, xws))
                {
                    ...
                    // TODO: Add when in Database/TMDB
                    //if (tvEpisode.OriginalName.IsNotNullOrWhiteSpace())
                    //{
                    //    details.Add(new XElement("originaltitle", tvEpisode.OriginalName));
                    //}
